  ...
  return (
    <>
      <div className="h-auto flex flex-col max-w-full overflow-hidden">
          ...
          <div className="mx-48 flex justify-between items-center">
            ...
            <div className="flex flex-col items-start w-1/2 space-y-8 text-white -translate-y-12">
              ...
              <p className="text-lg leading-relaxed">
                Trustopay provides a secure solution for handling online
                transactions, using escrow services to safeguard funds until the
                buyer and seller have both fulfilled their obligations. This
                approach minimizes the risk of fraud and ensures that payments
                are only released once all parties are satisfied, offering a
                safe and reliable experience for users.
              </p>
              <Link to="/contact">
                <button
                  type="button"
        ...
        <div className="h-auto flex flex-col items-center justify-center bg-white py-16 px-4 sm:px-6 md:px-48 mb-4">
          <h2 className="text-4xl text-center font-custom text-gray-900 mb-4">
            Easebuzz offers full-stack payment solutions tailored to ecommerce
            businesses
          </h2>
          <p className="text-lg text-gray-600 text-center mb-12 max-w-6xl">
            Merchants can easily set up an online store, accept payments, issue
            refunds, and integrate a plug-and-play API-based payment gateway
            with a customizable checkout page including discount coupons &
            cashback offers.
          </p>
            ...
            <div className="flex space-x-12">
              ...
              <div className="flex flex-col items-left  text-left max-w-xs">
                <div className="h-16 w-16 flex justify-center items-center rounded-full border-2 border-blue-300 mb-4">
                  <img
                    className="h-10 w-10"
                    src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/quick.svg"
                    alt="Quick Onboarding Icon"
                  />
                </div>
                <p className="font-bold text-lg">Secure Payment Processing</p>
                <p className="text-gray-600">
                  Trustopay uses advanced encryption and fraud detection to
                  secure transactions.
                </p>
              </div>
              ...
              <div className="flex flex-col  items-left  text-left max-w-xs">
                <div className="h-16 w-16 flex justify-center items-center rounded-full border-2 border-blue-300  mb-4">
                  <img
                    className="h-10 w-10"
                    src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/instant.svg"
                    alt="Instant Settlements Icon"
                  />
                </div>
                <p className="font-bold text-lg">Flexible Payment Options</p>
                <p className="text-gray-600">
                  Trustopay supports diverse payment methods, including digital
                  wallets and cards.
                </p>
              </div>
              ...
              <div className="flex flex-col  items-left  text-left max-w-xs">
                <div className="h-16 w-16 flex justify-center items-center rounded-full border-2 border-blue-300  mb-4">
                  <img
                    className="h-10 w-10"
                    src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/auto.svg"
                    alt="Webhook Notification Icon"
                  />
                </div>
                <p className="font-bold text-lg">User-Friendly Interface</p>
                <p className="text-gray-600">
                  Trustopay offers an intuitive interface for easy transactions.
                </p>
              </div>
              ...
              <div className="flex flex-col  items-left  text-left max-w-xs">
                <div className="h-16 w-16 flex justify-center items-center rounded-full border-2 border-blue-300  mb-4">
                  <img
                    className="h-10 w-10"
                    src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/refund.svg"
                    alt="Instant Refunds Icon"
                  />
                </div>
                <p className="font-bold text-lg">Real-Time Analytics</p>
                <p className="text-gray-600">
                  Trustopay provides real-time analytics for optimizing payment
                  strategies.
                </p>
              </div>
            </div>
        ...
        <div className="h-auto px-48 py-16  space-y-12">
          <div className="flex w-full  justify-center gap-8 ">
            <div className="w-1/2 h-auto">
              <img
                ...
                src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/coupon_engine.gif"
                alt=""
              />
            </div>
            <div className=" w-1/2 h-auto  space-y-10">
              <p className="text-4xl font-custom font-bold">
                The Most Reliable and Secure Payment Solution
              </p>
            ...
            <p><span className='font-bold'>Brand Coupons</span> allow customers to select, manage and customise cashback coupons during the checkout process.</p> */}
              <p>
                Trustopay is a trusted and secure payment platform that adheres
                to the highest industry standards. Our platform is regularly
                audited to ensure compliance with financial regulations and
                security protocols. These thorough audits are conducted to
                protect user information, verify the safety and reliability of
                our services, and ensure adherence to payment processing
                regulations.
              </p>
            </div>
          </div>
          <div className="flex flex-row-reverse w-full  justify-center gap-8 ">
            <div className="w-1/2 h-auto">
              <img
                className="h-80 w-full"
                src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case/customization.svg"
                alt=""
              />
            </div>
            <div className=" w-1/2 h-auto  space-y-10">
              <p className="text-4xl font-custom font-bold">
                Secure Payments for Your Website, Marketplace, or App
              </p>
              <p>
                <span className="font-bold">
                  Designed by Developers for Developers
                </span>{" "}
                Any business can easily integrate Trustopay’s secure payment
                solutions into their platform, as seamlessly as common payment
                methods like Stripe.
              </p>
              <p>
                <span className="font-bold">
                  Ensuring Safety for Both Buyers and Sellers
                </span>{" "}
                With Trustopay, buyers benefit from secure transactions and
                protection through real-time payment monitoring. Sellers are
                safeguarded from chargebacks and fraud, ensuring a secure and
        ...
        <div className="relative h-[600px]  flex justify-center items-center w-full">
          ...
          <div
            style={{ clipPath: "polygon(100% 10%, 100% 75%, 0 98%, 0 30%)" }}
            className="absolute top-0 left-0 w-full h-full bg-gray-200 z-[-1]"
          ></div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col">
                  <p className="text-md font-medium text-gray-600 mb-2">
                    Trustopay offers a streamlined and efficient payment process
                    for e-commerce platforms, ensuring smooth transactions from
                    start to finish. Our solution simplifies payment collection
                    with minimal friction, enhancing the overall user experience
                    and allowing businesses to focus on growth while we handle
                    the complexities of payment processing securely and
                    reliably.
                  </p>
                </div>
                <div className="space-x-4 flex">
                  ...
                  <a href="https://play.google.com/store/search?q=trustopay&c=apps&hl=en_US">
                  <button className="flex items-center px-6 py-2 border-2 hover:bg-gradient-to-r from-[#703893] to-[#3f4195] border-[#703893] text-[#703893] font-semibold rounded-full transition duration-300 hover:bg-[#703893] hover:text-white">
                    Download App
                  </button>
                  </a>
      ...
      <div className="flex w-full items-center justify-center h-auto  py-12  ">
        <p className="text-4xl  font-custom bg-gradient-to-r from-[#703893] to-[#3f4195] text-transparent bg-clip-text ">
          Case Study
        </p>
      </div>
      <div className="    bg-gray-200 flex mx-24 items-center gap-12 px-24 rounded-xl h-60">
        <div>
          <img
            src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/feesbuzz/case-study-parul/parul_logo.png"
            alt=""
            className="p-3"
          />
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-custom">
            Parul University witnesses 60% improvement in fee collection cycle
            with Easebuzz payment solutions
          </h2>
          <p>
            Parul University comprises of 36 institutes with a plethora of
            diploma, undergraduate and post graduate programs in numerous
            disciplines. Offering a range of over 450 uniquely structured
            programs, designed to suit the career prospects of every student
            aspirant.
          </p>
        </div>
      </div>
        ...
        <div className="h-auto w-full px-2">
          ...
          <div className="flex items-start  justify-between mt-2 space-x-4">
            ...
            <div className="w-3/5  p-2 ">
              <p>
                Parul University basic requirement was to deploy a system which
                manages the entire administration system digitally and make
                education fee collection faster, and easier for students as well
                as the accounts department of the university.
              </p>
              <ul className="mt-2 space-y-2">
                <li>
                  <FontAwesomeIcon icon={faCircleCheck} />
                  <span className="ml-2">
                    Difficulty in splitting fees between departments as per
                    batches or courses
                  </span>
                </li>
                <li>
        ...
        <div className="h-auto w-full px-2">
          ...
          <div className="flex items-start  justify-between mt-2 space-x-4">
            ...
            <div className="w-1/2  p-2 ">
              <p>
                FeesBuzz helped Parul university to collect fees from students
                on a single link and splitting it to academic & hostel fees with
                automatic recocnciliation. With EasyCollect they were able to
                send payment links with payment reminders to all the fee
                defaulters.
              </p>
              <p>l</p>
            </div>
            ...
            <div className="w-1/2">
              <p>
                Slices helped to split payment batch and course wise. The
                integration of payment gateway and payment links helped with fee
                collection for college events with customised & detailed
        ...
        <div className="h-30 w-full px-2">
          ...
          <div className="flex items-center p-8 justify-between mt-4 ">
            <div className="w-1/5">
              ...
              <img
                src="https://trustopay.vercel.app/assets/images/our%20team/Us.png"
            ...
            <div className="flex items-center mt-4 ml-4">
              <div className="ml-4 w-4/5 pl-12">
                <p className="italic text-gray-600">
                  "We have seen immense improvement in our fees collection
                  process with Easebuzz as they have automated and digitized
                ...
                <div className="flex items-center mt-2">
                  ...
                  {/* Name and Title */}
                  <div>
                    <p className="font-bold">Pinak Agrawal</p>
                    <p className="text-sm">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 pb-12 ">
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 text-center">
            <div className="flex justify-center mb-4">
              <img
                src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case-educational/secured-complained.svg"
                alt="PCI-DSS Level 1"
                className="w-12 h-12"
              />
            </div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 text-center">
            <div className="flex justify-center mb-4">
              <img
                src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case-educational/customer-support.svg"
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 text-center">
            <div className="flex justify-center mb-4">
              <img
                src="https://easebuzz.in/static/base/assets_aug_2021/img/easebuzz/use-case-educational/integration-with-tally.svg"
